...
y_pred = calibrated_rf.predict(X_test_unseen)
...
#Unseen data AUC
y_prob = calibrated_rf.predict_proba(X_test_unseen)[:, 1] 
...
# Apply Calibration
calibrated_ada_boost = CalibratedClassifierCV(ada_boost, method='isotonic', cv=5)
calibrated_ada_boost.fit(X_train, y_train)

# Evaluate Calibration
y_probs = calibrated_ada_boost.predict_proba(X_test)[:, 1]
brier_score = brier_score_loss(y_test, y_probs)
print(f"Brier Score (lower is better): {brier_score:.4f}")


#calculate test accuracy
y_pred = calibrated_ada_boost.predict(X_test)
accuracy = accuracy_score(y_test, y_pred)
print(f"Accuracy on test data: {accuracy:.4f}")


#Calculate unseen data accuracy
y_pred = calibrated_ada_boost.predict(X_test_unseen)
accuracy = accuracy_score(y_test_unseen, y_pred)
print(f"Accuracy on unseen test data: {accuracy:.4f}")
precision = precision_score(y_test_unseen, y_pred)
recall = recall_score(y_test_unseen, y_pred)
...
#Unseen data AUC
y_prob = calibrated_ada_boost.predict_proba(X_test_unseen)[:, 1] 
fpr, tpr, thresholds = roc_curve(y_test_unseen, y_prob)
roc_auc = auc(fpr, tpr)
...
# Apply Calibration
calibrated_decision_tree = CalibratedClassifierCV(decision_tree, method='sigmoid', cv=5)
calibrated_decision_tree.fit(X_train, y_train)

# Evaluate Calibration
y_probs = calibrated_decision_tree.predict_proba(X_test)[:, 1]
brier_score = brier_score_loss(y_test, y_probs)
print(f"Brier Score (lower is better): {brier_score:.4f}")


#calculate test accuracy
y_pred = calibrated_decision_tree.predict(X_test)
accuracy = accuracy_score(y_test, y_pred)
print(f"Accuracy on test data: {accuracy:.4f}")

#Calculate unseen data accuracy
y_pred = calibrated_decision_tree.predict(X_test_unseen)
accuracy = accuracy_score(y_test_unseen, y_pred)
print(f"Accuracy on unseen test data: {accuracy:.4f}")
precision = precision_score(y_test_unseen, y_pred)
recall = recall_score(y_test_unseen, y_pred)
...
#Unseen data AUC
y_prob = calibrated_decision_tree.predict_proba(X_test_unseen)[:, 1] 
fpr, tpr, thresholds = roc_curve(y_test_unseen, y_prob)
roc_auc = auc(fpr, tpr)
print("AUC Score for unseen test dataset: ", roc_auc)
...
# Apply Calibration
calibrated_log_reg = CalibratedClassifierCV(log_reg, method='isotonic', cv=5)
calibrated_log_reg.fit(X_train, y_train)

# Evaluate Calibration
y_probs = calibrated_log_reg.predict_proba(X_test)[:, 1]
brier_score = brier_score_loss(y_test, y_probs)
print(f"Brier Score (lower is better): {brier_score:.4f}")

#calculate test accuracy
y_pred = calibrated_log_reg.predict(X_test)
accuracy = accuracy_score(y_test, y_pred)
print(f"Accuracy on test data: {accuracy:.4f}")

#Calculate unseen data accuracy
y_pred = calibrated_log_reg.predict(X_test_unseen)
accuracy = accuracy_score(y_test_unseen, y_pred)
print(f"Accuracy on unseen test data: {accuracy:.4f}")
precision = precision_score(y_test_unseen, y_pred)
recall = recall_score(y_test_unseen, y_pred)
...
#Unseen data AUC
y_prob = calibrated_log_reg.predict_proba(X_test_unseen)[:, 1] 
fpr, tpr, thresholds = roc_curve(y_test_unseen, y_prob)
roc_auc = auc(fpr, tpr)
print("AUC Score for unseen test dataset: ", roc_auc)
brier_score = brier_score_loss(y_test_unseen, y_prob)
...
# Apply Calibration
calibrated_linear_SVC = CalibratedClassifierCV(linear_SVC, method='isotonic', cv=5)
calibrated_linear_SVC.fit(X_train, y_train)

# Evaluate Calibration
y_probs = calibrated_linear_SVC.predict_proba(X_test)[:, 1]
brier_score = brier_score_loss(y_test, y_probs)
print(f"Brier Score (lower is better): {brier_score:.4f}")

#calculate test accuracy
y_pred = calibrated_linear_SVC.predict(X_test)
accuracy = accuracy_score(y_test, y_pred)
print(f"Accuracy on test data: {accuracy:.4f}")

#Calculate unseen data accuracy
y_pred = calibrated_linear_SVC.predict(X_test_unseen)
accuracy = accuracy_score(y_test_unseen, y_pred)
print(f"Accuracy on unseen test data: {accuracy:.4f}")
precision = precision_score(y_test_unseen, y_pred)
recall = recall_score(y_test_unseen, y_pred)
...
#Unseen data AUC
y_prob = calibrated_linear_SVC.predict_proba(X_test_unseen)[:, 1] 
fpr, tpr, thresholds = roc_curve(y_test_unseen, y_prob)
roc_auc = auc(fpr, tpr)
print("AUC Score for unseen test dataset: ", roc_auc)
